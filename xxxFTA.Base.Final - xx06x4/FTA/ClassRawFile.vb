...
Err_Renamed:
    ...
    Public Sub ReadDataFileF(ByRef DataFileName As String)
        ...
        Dim SeisIndex() As String = {"S015_", "S03_", "S05_", "S07_", "S09_", "S10_"} '지진구간별 index, S015, S03...
        ...
        For sin = 0 To 5
            ...
            For index = 1 To arrCount
                ...
                s = XData.EventName(iE) & " - " & XData.EventProb(iE).ToString & " - " & XData.EventDistrP1(iE).ToString
                Message.Add(s)
n1:
            Next
        Next
