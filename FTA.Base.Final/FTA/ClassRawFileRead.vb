Public Class ClassRawFileRead
    ...
    ' Read Cut Set
    ' Cut Set 읽기 ---------------------------------------------------
    Public Sub ReadRawFile(ByRef RawFileName As String, ByRef CsBlockName As String)
        ...
        ' File 이 없으면 에러
        If (Not IsExistFile(RawFileName)) Then
            Console.WriteLine(vbCrLf + "Error: No File")
