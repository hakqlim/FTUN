Public Class ClassBdd
    ...
    Dim ite As List(Of ite_def)

    'Dim ite() As ite_def   ' ite를 저장하기 위한 Array 들
    'Dim noite As Integer    ' ite 의 수
    'Dim mxite As Integer = 100000   ' 최대 할당할 수 있는 ite 수
    ...
    Dim pEvent_to_ite() As Integer    ' 각 FT에 대해 계산된 결과 : ite 에 대한 pointer (FT.XEvents.Count 만큼 필요)
    ...
    Public Sub Initialize(FT_In As ClassFtData)
        ...
        ' 아래는 ite를 Array 로, ite_def는 Structure로 설정하는 경우 필요
        'ReDim ite(mxite)
