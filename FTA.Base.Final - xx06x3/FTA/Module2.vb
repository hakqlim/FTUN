Module Module2
    ...
    Public Declare Function LogN Lib "H:\Work\FTA_Execise - x06 - 복사본 - 복사본\xaigo\Debug\aigo.dll" (ByVal m As Double, ByVal s As Double) As Double
    ...
    Public Declare Function UniFoR Lib "H:\Work\FTA_Execise - x06 - 복사본 - 복사본\xaigo\Debug\aigo.dll" (ByVal m As Double, ByVal s As Double) As Double
    Public Declare Function BetaR Lib "H:\Work\FTA_Execise - x06 - 복사본 - 복사본\xaigo\Debug\aigo.dll" (ByVal m As Double, ByVal s As Double) As Double

    Private Declare Sub AddLongs_Pointer Lib "H:\Work\FTA_Execise - x06 - 복사본 - 복사본\test\Debug\test.dll" (ByRef FirstElement As Double, ByVal lElements As Integer, ByVal Itype As Integer, ByVal m As Double, ByVal s As Double)
