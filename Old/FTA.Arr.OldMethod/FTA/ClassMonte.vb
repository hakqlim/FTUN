Public Class ClassMonte
    ...
    Public Sub Initialize(FT_In As ClassFtData, NoSample_In As Integer)
        ...
        ' Array 설정
        ReDim E_State(FT.NoEvent)
        ReDim E_Count(FT.NoEvent)
        ReDim E_Visited(FT.NoEvent)
    ...
    Private Function EvaluateTopEventProbability(T As Integer) As Single
        ...
        For i = 1 To NoSample
            ...
            For j = 2 To FT.NoEvent
                If (FT.XEvents(j).NoChild = 0) Then
                    r = Rnd()
                    ' State of Event j
    ...
    Private Function GetState(G As Integer) As Integer
        ...
        For j = 0 To FT.XEvents(G).NoChild - 1
    ...
    Private Sub PrintGateValue(ByRef S As String)
        ...
        For i = 2 To FT.NoEvent
            If (FT.XEvents(i).NoChild > 0) Then ' Gate
